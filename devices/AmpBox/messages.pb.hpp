...
/* Generated by nanopb-0.3.4 at Fri Dec 11 16:11:55 2015. */
...
const pb_field_t ServiceMessage_fields[11] = {
    ...
    PB_ONEOF_FIELD(payload,   8, MESSAGE , ONEOF, STATIC  , OTHER, ServiceMessage, numberValue, messageId, &NumberValue_fields),
    PB_ONEOF_FIELD(payload,   9, MESSAGE , ONEOF, STATIC  , OTHER, ServiceMessage, setNumber, messageId, &SetNumber_fields),
    PB_ONEOF_FIELD(payload,  10, MESSAGE , ONEOF, STATIC  , OTHER, ServiceMessage, logMessage, messageId, &LogMessage_fields),
    PB_LAST_FIELD
};
...
const pb_field_t NumberValue_fields[3] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, NumberValue, path, path, 0),
    PB_FIELD(  2, INT32   , REQUIRED, STATIC  , OTHER, NumberValue, value, path, 0),
    PB_LAST_FIELD
};

const pb_field_t SetNumber_fields[3] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, SetNumber, path, path, 0),
    PB_FIELD(  2, INT32   , REQUIRED, STATIC  , OTHER, SetNumber, value, path, 0),
    PB_LAST_FIELD
};

const pb_field_t LogMessage_fields[3] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, LogMessage, deviceId, deviceId, 0),
    PB_FIELD(  2, STRING  , REQUIRED, STATIC  , OTHER, LogMessage, text, deviceId, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(ServiceMessage, payload.unsubscribe) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_ServiceMessage_Ping_Pong_Subscribe_Unsubscribe_Get_NumberValue_SetNumber_LogMessage_Error)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(ServiceMessage, payload.unsubscribe) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_ServiceMessage_Ping_Pong_Subscribe_Unsubscribe_Get_NumberValue_SetNumber_LogMessage_Error)
#endif
