 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(ServiceMessage, payload.unsubscribe) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_ServiceMessage_Ping_Pong_Subscribe_Unsubscribe_Get_NumberValue_SetNumber_Error)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(ServiceMessage, payload.unsubscribe) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_ServiceMessage_Ping_Pong_Subscribe_Unsubscribe_Get_NumberValue_SetNumber_Error)
#endif
