 ...
 **************************************************************/
/**************************************************************
 * 05/12/2015 - Converted to hhp file and added connection state callback
**************************************************************/
...
typedef void (*connectionStateCallback)(bool);
...
public:
    ...
    bool autoConnect(connectionStateCallback callback, bool forceAPMode = false) {

        String ssid = "ESP" + String(ESP.getChipId());
        return autoConnect(ssid.c_str(), callback, forceAPMode);
    }

    bool autoConnect(char const *apName, connectionStateCallback callback, bool forceAPMode = false) {
